...
class DesignConstants {
  ...
  static const Color lightPrimaryText = Color(0xFF0D1F4A);
  static const Color lightSecondaryText = Color(0xFF6B80A0);
  ...
  static const Color lightSecondary = Color(0xFF00C8FF);
