...
enum PlantType {
  ...
  static PlantType fromCsvFuel(String fuel) {
    ...
    if (lower.contains('oil') || lower.contains('petrol')) {
      return PlantType.oil;
    }
    if (lower.contains('biomass')) {
      return PlantType.biomass;
    }
    if (lower.contains('geothermal')) {
      return PlantType.geothermal;
    }
    if (lower.contains('waste')) {
      return PlantType.waste;
    }
    if (lower.contains('wave') || lower.contains('tidal')) {
      return PlantType.wave;
    }
    if (lower.contains('storage')) {
      return PlantType.storage;
    }
    if (lower.contains('cogeneration')) {
      return PlantType.cogeneration;
    }
    if (lower.contains('petcoke')) {
      return PlantType.petcoke;
    }
